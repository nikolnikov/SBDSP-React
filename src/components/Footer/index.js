...
const Footer = ({ customClasses = [], logo, hasNav, margins, maxWidth }) => {
          ...
          <div className="ds-footer__wrapper">
            ...
            <div className="ds-footer__content">
              ...
              <div className="ds-footer__copyright">
                Quest<sup>&reg;</sup> is the brand name used for services
                offered by Quest Diagnostics Incorporated and its affiliated
                companies. Quest Diagnostics Incorporated and certain affiliates
                are CLIA certified laboratories that provide HIPAA covered
                services.  Other affiliates operated under the Quest
                <sup>&reg;</sup> brand, such as Quest Consumer Inc., do not
                provide HIPAA covered services.
                <br />
                <br />
                Quest, Quest Diagnostics, any associated logos, and all
                associated Quest Diagnostics registered or unregistered
                trademarks are the property of Quest Diagnostics. All third
                party marks —<sup>&reg;</sup> and &trade; — are the property of
                their respective owners. &copy; {year} Quest Diagnostics
                Incorporated. All rights reserved. Image content features models
                and is intended for illustrative purposes only.
              </div>
            </div>
          </div>
        </div>
